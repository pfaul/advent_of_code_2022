...
public enum GameLogicEnum
{
    LOOSE("X"){
        ...
        public SymbolEnum getMySymbol(OpponentSymbolEnum opponentSymbol)
        {
            ...
            {
                case ROCK -> {return SymbolEnum.SCISSORS;}
                case PAPER -> {return SymbolEnum.ROCK;}
                case SCISSORS -> {return SymbolEnum.PAPER;}
            }
            return null;
        }
    },
    DRAW("Y")
            {
                ...
                public SymbolEnum getMySymbol(OpponentSymbolEnum opponentSymbol)
                {
                    switch (opponentSymbol)
                    {
                        case ROCK -> {return SymbolEnum.ROCK;}
                        case PAPER -> {return SymbolEnum.PAPER;}
                        case SCISSORS -> {return SymbolEnum.SCISSORS;}
                    }
                    return null;
                }
            },
    WIN("Z")
            {
                ...
                public SymbolEnum getMySymbol(OpponentSymbolEnum opponentSymbol)
                {
                    switch (opponentSymbol)
                    {
                        case ROCK -> {return SymbolEnum.PAPER;}
                        case PAPER -> {return SymbolEnum.SCISSORS;}
                        case SCISSORS -> {return SymbolEnum.ROCK;}
                    }
                    return null;
                }
            };
